#Code written by Marty Bissonnette
...
def snakegame():
    ...
    class Apple:
        ...
        def __init__(self, parent_screen):
            ...
            self.image = pygame.image.load("Apple (Generated with Dalle3).png").convert()
    ...
    class Snake:
        ...
        def __init__(self, parent_screen, length):
            ...
            self.block = pygame.image.load("yellow_circle_new (Self Drawn).png").convert()
            self.head = pygame.image.load("sad_face (Self Drawn).png").convert()
            self.second_head = pygame.image.load("happy_face (Self Drawn).png").convert()
            self.third_head = pygame.image.load("heart_face (Self Drawn).png").convert()
            self.fourth_head = pygame.image.load("winner (Self Drawn).png").convert()
