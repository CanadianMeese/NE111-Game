...
def rubiksgame():
    ...
    def start_screen():
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                # Check for key presses.
                    ...
                    # Enter arcade mode if the 'A' key is pressed.
                        ...
                        return 'quit'  # Exit with 'arcade' signal to start the arcade mode.
            ...
            # Render the prompt for quitting out.
            quitPrompt = font.render('Press "X" to Exit', True, white)
            quitPrompt_rect = quitPrompt.get_rect(center=(width / 2, (height / 3) + 150))
            ...
            screen.blit(quitPrompt, quitPrompt_rect)
