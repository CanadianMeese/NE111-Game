...
def mainrubiks():
    ...
    def start_screen():
        while True:
            ...
            exitPrompt = font.render('Press "X" to Go Back', True, white)
            exitPrompt_rect = exitPrompt.get_rect(center=(width / 2, (height / 3) + 150))
            ...
            screen.blit(exitPrompt, exitPrompt_rect)
